...
To accelarte the training time, we use the server
for retraining the compressed networks to regain accuracy.
The server has 4 NVIDIA Tesla P40 GPU and each owns 24 GB video memory.
...
and CUDA (v8.0.64).
The server runs redhat 7.3.1 with Linux kernel v3.10.0. The NVIDIA Tesla P40 works with NVIDIA Quadro vDWS software.
