...
%Describe hardware
\cparagraph{Hardware.} Our experimental platform is a NVIDIA Jetson TX2 embedded deep learning platform. The system has a 64~bit dual-core
...
%Describe software
\cparagraph{System Software.} We run the Ubuntu 16.04 operating system with Linux kernel v4.4.15. We use Tensorflow v.1.0.1, cuDNN (v6.0)
and CUDA (v8.0.64).
