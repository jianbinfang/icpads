...
Consider a scenario for browsing four \texttt{BBC} news pages, starting from the home page of \BBCW. Our evaluation device is an ARM big.LITTLE mobile platform with  a Cortex-A15 (big) and a Cortex-A7 (little)
processors.
