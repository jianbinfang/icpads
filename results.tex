...
the operations into seven classes, listed from A to G in the table on the right-hand side.
\FIXME{We only list important operation which contributes more than 1\% of execution time}. Each cell of the heatmap represents the
...
\begin{figure*}[!t]
\centering
\subfloat[][Model size]{\includegraphics[width=0.29\textwidth]{figure/quan_size.pdf}}
\hfill
\subfloat[][Inference time]{\includegraphics[width=0.31\textwidth]{figure/quan_time2.pdf}}
\hfill
\subfloat[][Accuracy]{\includegraphics[width=0.3\textwidth]{figure/quan_acc3.pdf}}
\hfill
\subfloat[][Power]{\includegraphics[width=0.28\textwidth]{figure/quan_power2.pdf}}
\hfill
\subfloat[][Energy consumption]{\includegraphics[width=0.3\textwidth]{figure/quan_energy2.pdf}}
\hfill
...
\begin{figure*}[!t]
\centering
\subfloat[][VGG\_16]{\includegraphics[width=0.24\textwidth]{figure/prun_vgg.pdf}}
\hfill
\subfloat[][ResNet\_50]{\includegraphics[width=0.24\textwidth]{figure/prun_resnet.pdf}}
\hfill
\subfloat[][NMT]{\includegraphics[width=0.24\textwidth]{figure/prun_NMT.pdf}}
\hfill
...
\begin{figure*}[!t]
\centering
\subfloat[][Model size]{\includegraphics[width=0.25\textwidth]{figure/prun_size.pdf}}
\hfill
\hspace{3mm}
\subfloat[][Inference time]{\includegraphics[width=0.25\textwidth]{figure/prun_time.pdf}}
\hfill
\hspace{3mm}
\subfloat[][Accuracy]{\includegraphics[width=0.25\textwidth]{figure/top1_5_prun.pdf}}
\hfill
\subfloat[][Power consumption]{\includegraphics[width=0.26\textwidth]{figure/prun_power.pdf}}
\hfill
\hspace{3mm}
\subfloat[][Energy consumption]{\includegraphics[width=0.24\textwidth]{figure/prun_energy.pdf}}
\hfill
\hspace{3mm}
\subfloat[][precision, recall and F1 score]{\includegraphics[width=0.26\textwidth]{figure/prun_prf.pdf}}
\hfill
...
\begin{figure*}[!t]
\centering
\subfloat[][Inference time vs accuracy]{\includegraphics[width=0.33\textwidth]{figure/quan_after_time.pdf}}
\hfill
\subfloat[][Energy vs accuracy]{\includegraphics[width=0.33\textwidth]{figure/quan_after_energy.pdf}}
\hfill
\subfloat[][Compressed model size vs accuracy]{\includegraphics[width=0.32\textwidth]{figure/quan_after_size.pdf}}
