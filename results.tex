...
\hfill
\subfloat[][Compressed model size vs accuracy]{\includegraphics[width=0.33\textwidth]{figure/quan_after_size.pdf}}
...
Table~\ref{tab:workload}).} \label{fig:bubblequantization}
\end{figure*}


\begin{figure*}[t!]
\centering
\subfloat[][Inference time vs accuracy]{\includegraphics[width=0.32\textwidth]{figure/prun_after_time.pdf}}
\hfill
\subfloat[][Energy vs accuracy]{\includegraphics[width=0.33\textwidth]{figure/prun_after_energy.pdf}}
\hfill
\subfloat[][Compressed model size vs accuracy]{\includegraphics[width=0.33\textwidth]{figure/prun_after_size.pdf}}
\hfill
