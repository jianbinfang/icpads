...
\begin{figure}[!t]
\centering
\subfloat[][Inference time]{\includegraphics[width=0.24\textwidth]{figure/quan_after_time.pdf}}
\hfill
\subfloat[][Energy]{\includegraphics[width=0.24\textwidth]{figure/quan_after_energy.pdf}}
\hfill
...
\begin{figure*}[t!]
\centering
\subfloat[][Inference time]{\includegraphics[width=0.25\textwidth]{figure/prun_after_time.pdf}}
\hfill
\subfloat[][Energy]{\includegraphics[width=0.25\textwidth]{figure/prun_after_energy.pdf}}
\hfill
\subfloat[][Model size]{\includegraphics[width=0.25\textwidth]{figure/prun_after_size.pdf}}
\hfill
