...
\begin{figure*}[!t]
\centering
\subfloat[][Inference time vs accuracy]{\includegraphics[width=0.45\textwidth]{figure/quan_after_time.pdf}}
\hfill
\subfloat[][Energy vs accuracy]{\includegraphics[width=0.45\textwidth]{figure/quan_after_energy.pdf}}
\hfill
...
\begin{figure*}[t!]
\centering
\subfloat[][Inference time vs accuracy]{\includegraphics[width=0.33\textwidth]{figure/prun_after_time.pdf}}
\hfill
