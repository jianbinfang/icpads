...
Jetson Tx2. We perform extensive experiments by considering 13 influential neural network architectures from the image classification and
...
pruning, perform on these network architectures and the implications compression techniques to the \DNN storage size, inference time,
