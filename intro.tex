...
to deal with a huge number of operations, up to $O(10^9)$ operations\FIXME{cite{}}
for one inference 
...
such as \FIXME{\cite{}applications name} using the cloud-based APIs
...
reduction of \FIXME{xxx\%} for model size,
while the inference time rise about \FIXME{xxx\%}.
